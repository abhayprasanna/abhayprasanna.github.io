...
//random = window.roamAlphaAPI.q('[:find [(rand 1 ?block-uid)] :where [?e :block/page] [?e :block/uid ?block-uid] ]')[0] // Thanks to @GitMurf for this one; this will return ONLY blocks, NOT pages - comment out previous line and/or replace with this line if you wwant it that way  
